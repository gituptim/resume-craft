...
export const templateList: { id: TemplateType; name: string; description: string; thumbnail: string }[] = [
  {
    ...
    thumbnail: `${import.meta.env.BASE_URL}template-classic-thumb.png`,
  },
  {
    id: 'modern',
    name: TEMPLATE_NAMES.modern,
    description: '双栏布局，信息密度高',
    thumbnail: `${import.meta.env.BASE_URL}template-modern-thumb.png`,
  },
  {
    id: 'minimal',
    name: TEMPLATE_NAMES.minimal,
    description: '极致简约，大量留白',
    thumbnail: `${import.meta.env.BASE_URL}template-minimal-thumb.png`,
  },
  {
    id: 'creative',
    name: TEMPLATE_NAMES.creative,
    description: '非对称设计，视觉冲击',
    thumbnail: `${import.meta.env.BASE_URL}template-creative-thumb.png`,
  },
  {
    id: 'elegant',
    name: TEMPLATE_NAMES.elegant,
    description: '优雅学术风，双栏温暖色调',
    thumbnail: `${import.meta.env.BASE_URL}template-elegant-thumb.png`,
  },
  {
    id: 'tech',
    name: TEMPLATE_NAMES.tech,
    description: '科技现代风，深色顶部栏',
    thumbnail: `${import.meta.env.BASE_URL}template-tech-thumb.png`,
  },
  {
    id: 'timeline',
    name: TEMPLATE_NAMES.timeline,
    description: '时间线设计，职业发展轨迹',
    thumbnail: `${import.meta.env.BASE_URL}template-timeline-thumb.png`,
  },
  {
    id: 'compact',
    name: TEMPLATE_NAMES.compact,
    description: '紧凑高效，内容极多首选',
    thumbnail: `${import.meta.env.BASE_URL}template-compact-thumb.png`,
  },
]
